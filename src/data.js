...
export const PROJECTS = [
  ...
  /* ── Current personal work ── */
  {
    id: "PRJ-01",
    title: "Swoop",
    sub: "Self-Hosted AI Job-Application Agent",
    cat: ["AI", "PERSONAL"],
    status: "In Development",
    featured: true,
    domain: "AI Agents",
    desc: "A self-hosted AI job-application agent: it watches roles across Greenhouse, Lever, Ashby, Workday, and LinkedIn, scores each posting's fit with Claude, tailors a resume and cover letter to the listing, files applications human-in-the-loop, and tracks every reply in one pipeline.",
    impact: "Personal build — self-hosted, private, approve-before-send by default.",
    details:
      "FastAPI + SQLModel backend (Argon2 auth, encrypted per-user secrets) with Playwright automation and the Anthropic SDK for fit-scoring and tailoring; a Vite / React / TypeScript dashboard; deployed via Docker Compose behind Caddy and a Cloudflare Tunnel. Nothing is submitted without human approval, and it never fabricates facts about you. Layered on the open-source AIHawk applier (AGPL). Repository is private.",
    tags: ["FastAPI", "Python", "React", "TypeScript", "Claude API", "Playwright", "Docker"],
    link: null,
  },
  {
    id: "PRJ-02",
