export const profile = {
  name: "Micheal Wolski",
  // Cybersecurity is the identity. AI agents and automotive/embedded are the
  // specialisations inside it — in that order, matching the GitHub profile.
  ...
  focusAreas: ["AI Security & Agents", "Automotive & Embedded", "Full-Stack"],
  heroSummary:
    "Cybersecurity engineer building secure, practical software — with a specialty focus in AI agents and automotive/embedded systems, alongside full-stack and enterprise tooling.",
  aboutParagraphs: [
    "I'm a cybersecurity engineer based in Michigan. My work sits in two places most people treat as separate: securing AI systems, and securing the embedded computers inside vehicles. I graduated from Eastern Michigan University with a B.S. in Information Assurance & Cyber Defense, after an A.A.S. in Computer Information Systems from Henry Ford College.",
    ...
    "I'm looking for full-time cybersecurity roles. AI security and automotive/embedded are where I'd most like to land, but any role where I'm actually shipping software works for me.",
  ],
  currentlyExploring: [
