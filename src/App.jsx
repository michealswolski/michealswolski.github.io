...
const PROJECTS = [
  {id:"BSH-001",title:"Cybersecurity Visibility Platform",sub:"Power Apps + SharePoint + Power BI — Bosch Internship",desc:"Self-initiated, end-to-end enterprise security visibility platform built entirely from scratch. Full stack: Power Apps canvas app for standardized project intake, SharePoint database architecture, and Power BI dashboard aggregating 40+ security projects across five divisions with drill-through reporting and executive presentations.",tags:["Power BI","DAX","Power Apps","Power Automate","SharePoint","Power Query","Database Architecture","ALM"],cat:"INTERNSHIP",domain:"Analytics & Enterprise Apps",impact:"40+ projects tracked across five divisions; standardized intake, cross-functional alignment, and sales enablement",details:"Built to solve fragmented project tracking across multiple automotive OEM programs (aggregating project data from Ford, GM, and other OEM initiatives). The platform is one cohesive system with three layers: (1) Power Apps canvas app — multi-step intake wizard with dark futuristic UI, role-based admin dashboards, and integrated ticketing, hardened for cross-tenant deployment; (2) SharePoint backend — structured database architecture for consistent data across divisions; (3) Power BI dashboard — dark-themed custom UI with drill-through reporting, KPI cards, conditional formatting, and automated refresh. Delivered executive presentations to business unit leaders and authored onboarding learning materials for the full platform."},
  {id:"BSH-004",title:"IECS Automation Flow",sub:"GM Programs · Process Creation & Automation — Bosch Internship",desc:"Designed and created automated workflow process for GM programs' Internal Engineering Change System (IECS). Built new engineering change management procedures from scratch and implemented full automation using Power Automate and SharePoint integration, streamlining keyless entry system change approvals and reducing manual coordination overhead.",tags:["Power Automate","SharePoint","Power Apps","Microsoft 365","Workflow Automation","GM OEM"],cat:"INTERNSHIP",domain:"Enterprise Automation",impact:"Created new automated IECS process for GM programs — end-to-end from concept to deployment",details:"Created entirely from scratch to solve unstructured engineering change management for GM programs. Designed workflow procedures and implemented automation: cross-divisional approval workflows for keyless entry system changes, real-time status tracking and notification system, Power Automate + SharePoint integration, and significant reduction in manual coordination overhead. Distinct from data aggregation work — this was active process creation and automation for GM programs."},
                  ...
                  <div style={{ marginBottom:28 }}>
                    ...
                    <ul style={{ paddingLeft:18, display:"flex", flexDirection:"column", gap:7 }}>
                      {[
                        ...
                        "Designed and created automated workflow process for GM programs' IECS (Internal Engineering Change System), establishing new engineering change procedures for keyless entry systems and implementing full Power Automate + SharePoint automation.",
