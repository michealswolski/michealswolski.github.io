...
const CAREER = {
  current: {
    ...
    color: "#E20015",
    points: [
      "Self-initiated and led development of comprehensive cybersecurity visibility platform built entirely from scratch — full stack covering Power Apps canvas app for standardized project intake, SharePoint database architecture, and centralized Power BI dashboard aggregating 40+ security projects across five divisions. Delivered executive presentations to business unit leaders, created onboarding materials, and drove cross-functional alignment and sales enablement through security capability demonstration.",
