                ...
                <div>
                  ...
                  <div style={{ marginBottom:28 }}>
                    ...
                    <ul style={{ paddingLeft:18, display:"flex", flexDirection:"column", gap:7 }}>
                      {[
                        "Self-initiated and led end-to-end cybersecurity visibility platform from scratch — Power Apps intake portal, SharePoint database, and Power BI dashboard aggregating 40+ security projects across five divisions; delivered executive presentations and onboarding materials.",
