    ...
    <>
      ...
      {/* Gradient blobs */}
        ...
        <div style={{ background: th.isDark?"rgba(13,17,23,0.9)":"rgba(15,23,42,0.93)", border:`1px solid ${th.isDark?"rgba(129,140,248,0.3)":"rgba(79,70,229,0.25)"}`, borderRadius:14, padding:"16px 18px", boxShadow:"0 4px 24px rgba(0,0,0,0.3)" }}>
          ...
          {[{k:"THREAT_INTEL",v:"ACTIVE",c:"#3fb950"},{k:"HTB",v:"ONGOING",c:"#58a6ff"},{k:"IQPC_2026",v:"ATTENDED",c:"#a78bfa"},{k:"CLEARANCE",v:"PROD_SEC_INTERN",c:"#fbbf24"},{k:"STATUS",v:"OPEN_TO_WORK",c:"#f87171"},{k:"CERTS",v:"IN_PROGRESS",c:"#34d399"}].map(({k,v,c}) => (
