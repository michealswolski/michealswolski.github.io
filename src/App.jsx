...
const PROJECTS = [
  {id:"BSH-001",title:"Cybersecurity Visibility Platform",sub:"Power Apps + SharePoint + Power BI — Bosch Internship",desc:"Self-initiated, end-to-end enterprise security visibility platform built entirely from scratch. Full stack: Power Apps canvas app for standardized project intake, SharePoint database architecture, and Power BI dashboard aggregating 40+ security projects across five divisions with drill-through reporting and executive presentations.",tags:["Power BI","DAX","Power Apps","Power Automate","SharePoint","Power Query","Database Architecture","ALM"],cat:"INTERNSHIP",domain:"Analytics & Enterprise Apps",impact:"40+ projects tracked across five divisions; standardized intake, cross-functional alignment, and sales enablement",details:"Built to solve fragmented project tracking by aggregating project data from multiple OEM programs (Ford, GM, and other initiatives) into one platform. The system is one cohesive solution with three layers: (1) Power Apps canvas app — multi-step intake wizard with dark futuristic UI, role-based admin dashboards, and integrated ticketing, hardened for cross-tenant deployment; (2) SharePoint backend — structured database architecture for consistent data across divisions; (3) Power BI dashboard — dark-themed custom UI with drill-through reporting, KPI cards, conditional formatting, and automated refresh. Delivered executive presentations to business unit leaders and authored onboarding learning materials for the full platform."},
  {id:"BSH-004",title:"OEM Program Automate Flow",sub:"Enterprise Workflow Automation — Bosch Internship",desc:"Fully designed and implemented an enterprise-grade automation workflow for IECS (Internal Engineering Change System), streamlining cross-divisional engineering change management processes and reducing manual processing overhead.",tags:["Power Automate","SharePoint","Power Apps","Microsoft 365","Workflow Automation"],cat:"INTERNSHIP",domain:"Enterprise Automation",impact:"Automated end-to-end engineering change request lifecycle across divisions",details:"Built comprehensive workflow automation from concept to deployment, integrating with existing enterprise systems. Features automated end-to-end engineering change request lifecycle, cross-divisional approval workflows, real-time status tracking and notifications, and significant reduction in manual processing time."},
  {id:"BSH-006",title:"Bosch Internal AI Hackathon — Onboarding Agent",sub:"LLM + RAG Memory — Bosch Internship",desc:"Built an LLM-powered onboarding agent during an internal Bosch AI hackathon. Designed and connected a custom agent with RAG (Retrieval-Augmented Generation) memory pipeline to automate onboarding workflows and answer context-aware questions from internal documentation.",tags:["LLM Integration","RAG","Vector Embeddings","Python","AI Agents","Microsoft 365"],cat:"INTERNSHIP",domain:"AI Enablement",impact:"Won/placed in internal Bosch AI hackathon — custom RAG agent for automated onboarding",details:"Conceived, built, and demonstrated an LLM-powered onboarding agent from scratch during an internal Bosch AI hackathon. Connected an LLM to a custom RAG memory pipeline — ingesting internal documentation into a vector store, enabling the agent to retrieve relevant context and answer onboarding questions accurately. Demonstrates end-to-end AI agent development: document ingestion, embedding, retrieval, and conversational response generation."},
